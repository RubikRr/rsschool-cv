...
- Development and maintenance of corporate web applications on ASP.NET Core.
- Participation in the architecture design of new modules, refactoring of legacy code.
- Optimization of database queries (MS SQL Server), implementation of caching.
- Integration with third-party APIs, writing unit tests (xUnit).
- Team collaboration, code review, mentoring of junior developers.
***
